...
<div class="register ">
  <form method="post" style="max-width: 700px;" action="./AddProduct/Process">
    ...
    <input type="text" name="Name" id="Name" class="form-control" placeholder="Product Name"
      onkeyup="checkProduct(this.value)">
    ...
    <input type="number" class="form-control" id="Quantity" name="Quantity" placeholder="Quantity"
      onkeyup="checkQuantity(this.value)">
    ...
    <input type="text" class="form-control" name="Sell_price" id="Sell_price" placeholder="Sell Price"
      onkeyup="checkSellPrice(this.value)">
    <span id="warningSellPrice" class="warning"></span>

    <label for="Buy_price">Buy Price:</label>
    <input type="text" class="form-control" name="Buy_price" id="Buy_price" placeholder="Buy Price"
      onkeyup="checkBuyPrice(this.value)">
