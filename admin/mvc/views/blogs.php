...
<div class="container-fluid">
  ...
  <nav id="paging" aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item"><a class="page-link" href="./Blogs?page=1">Trang đầu</a></li>
      <li class="page-item"><a class="page-link" href="./Blogs?page=<?php echo ($data['currentPage'] - 1) ?>">
          << </a>
      </li>
      <li class="page-item"><a class="page-link" href="#"><?php echo ($data['currentPage']) ?></a></li>
      <li class="page-item"><a class="page-link" href="./Blogs?page=<?php echo ($data['currentPage'] + 1) ?>"> >>
        </a></li>
      <li class="page-item"><a class="page-link" href="./Blogs?page=<?php echo ($data['totalPages']) ?>">Trang
          cuối</a></li>
    </ul>
  </nav>
</div>
