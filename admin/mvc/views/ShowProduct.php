...
<div class="container-sm">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      ...
      <li class="page-item"><a class="page-link" href="./Product?page=<?php echo ($data['currentPage'] + 1) ?>"> >> </a></li>
      <li class="page-item"><a class="page-link" href="./Product?page=<?php echo ($data['totalPages']) ?>">Trang cuối</a></li>
    </ul>
  </nav>
</div>
<?php
