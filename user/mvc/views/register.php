...
<div class="register">
  <form onkeyup="checkValidation()">
    ...
    <input id="confirmPassword" type="password" class="form-control" name="confirmPassword" placeholder="Nhập lại mật khẩu">
    <span id="warningConfirmPassword" class="warning"></span>
    <label for="lastname">Họ*:</label>
    <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Nhập họ của bạn">
    <span id="warningLastname" class="warning"></span>
    <label for="firstname">Tên*:</label>
    <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Nhập tên của bạn">
