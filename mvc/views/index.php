...
<div class="home">
    <div class="container-md main-img">
        <img src="./public/assets/image/imgbg.webp" alt="main-img">
    ...
    <div class="misson">
        <div class="container-md">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="img">
                        <img src="./public/assets/image/pyriot-visual.gif" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="text">
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="item">
                        <img src="./public/assets/image/thietbi.png" alt="">
                        <h2>THIẾT BỊ</h2>
                ...
                <div class="col-12 col-md-3">
                    <div class="item">
                        <img src="./public/assets/image/ketnoi.png" alt="">
                        <h2>KẾT NỐI</h2>
                ...
                <div class="col-12 col-md-3">
                    <div class="item">
                        <img src="./public/assets/image/chuyendoi.png" alt="">
                        <h2>CHUYỂN ĐỔI</h2>
                ...
                <div class="col-12 col-md-3">
                    <div class="item">
                        <img src="./public/assets/image/trucquan.png" alt="">
                        <h2>TRỰC QUAN</h2>
    ...
    <div class="special">
        ...
        <div class="container-md">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="img">
                        <img src="./public/assets/image/special.webp" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="text">
    ...
    <div class="architecture">
        ...
        <img src="./public/assets/image/kientruc.webp" alt="">
    </div>
    <div class="profile">
        <div class="container-md">
            <div class="row">
